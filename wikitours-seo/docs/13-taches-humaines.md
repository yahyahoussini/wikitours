...
| A6 | Bing Webmaster Tools : import depuis GSC, sitemap, clé IndexNow (bd8d103eb3fdf7cf0e28400a77bc8cfd) ; `npm run indexnow` → 200/202 | 5.2, 4.3 | agence | sortie du script | ☐ |
